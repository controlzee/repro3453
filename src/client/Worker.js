...
var gWebsocketRelayClient = null;
...
var onmessage = function(e) {
    switch ( e.data.action ) {
        case 'init':
            ...
            gWebsocketRelayClient = new WebsocketRelayClient(hostname);
            gWebsocketRelayClient.onTextMessageReceived = onWebsocketRelayClientTextMessageReceived;
            break;

        case 'postMessage':
            var text = e.data.text;
            this.gWebsocketRelayClient.sendTextMessage(text);
            break;
    }
}

// When websocket gets a message
var onWebsocketRelayClientTextMessageReceived = function(message) {
    postMessage(message);
};
...
*/
function WebsocketRelayClient(hostname) {
